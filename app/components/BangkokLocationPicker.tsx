  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        ...
        >
          ...
          >
            ...
            <input
              ...
              className={`flex-1 py-2 pr-3 text-xs font-medium bg-transparent border-0 outline-none placeholder:font-normal ${
                darkMode
            ...
            {!searching && searchQuery && (
              <button
                ...
                className={`mr-2 p-1 rounded-md text-[10px] font-bold ${
                  darkMode
          ...
          {showResults && searchQuery.trim().length >= 2 && (
            <div
              className={`mt-1 rounded-xl shadow-lg border overflow-hidden max-h-40 overflow-y-auto ${
                darkMode
            ...
            >
              {searching ? (
                <div
                  className={`px-3 py-2.5 text-xs flex items-center gap-2 ${
                ...
                searchResults.map((result) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2.5 text-xs leading-relaxed border-b last:border-b-0 transition cursor-pointer ${
                      darkMode
        ...
        <div
          className={`absolute bottom-14 right-3 z-[500] backdrop-blur-sm px-2.5 py-1 rounded-lg shadow-sm border text-[10px] font-medium ${
            darkMode
        ...
        <button
          ...
          disabled={locating}
          className={`absolute bottom-3 right-3 z-[500] px-3 py-2 rounded-lg shadow-md flex items-center space-x-1.5 text-xs font-semibold transition active:scale-95 cursor-pointer disabled:opacity-70 ${
            darkMode
